...
import slide04 from '../../images/slides/slide-04.jpg';
            ...
            <Row className='max-height'>
                <Col xs={10} className='mx-auto div-col'>
                    <Carousel>
                        ...
                        <Carousel.Item>
                            <Image className='d-block w-100' src={slide03} alt='Second slide' fluid />
                            <Carousel.Caption className='text-left slide-in-top'>
                                <h1>খাদ্য মেলা ২০২২</h1>
                            </Carousel.Caption>
                        </Carousel.Item>
                        <Carousel.Item>
                            <Image className='d-block w-100' src={slide04} alt='Third slide' fluid />
                            <Carousel.Caption className='text-left slide-in-top'>
