...
import aboutPic from 'src/components/user/images/cover/nins-cover-original.png';
import { AIM_OBJECTIVES, CHARACTERISTICS } from 'src/components/user/Data';
            ...
            <Container fluid>
                ...
                <Row style={{ backgroundColor: '#fff' }} data-aos="fade-right">
                    <Col xs={10} lg={8} md={6} className="mx-auto px-lg-5 my-5">
                        ...
                        <div style={{ borderTop: '4px solid green', width: 50 }}></div>
                        <p className="my-4 text-muted w-100 about-text new-line">{CHARACTERISTICS}</p>
                    </Col>
